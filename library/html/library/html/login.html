...
<body>
    <div class="w3-display-container" style="height:50rem;">
            <div class="w3-display-middle w3-card w3-white w3-padding-large w3-round-xlarge">
                <img src="../img/logo.png" height="60rem">
                ...
                <a id="login" href="main" class="w3-margin-top w3-button w3-border w3-hover-green w3-margin-bottom w3-padding-large w3-round-xlarge"> Login </a>
            </div>
    </div>
