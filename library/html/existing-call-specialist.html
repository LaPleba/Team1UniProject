    ...
    <!-- Page Content -->
        <div class="w3-card w3-white w3-padding w3-row w3-round-xlarge" style="margin: 2%">
                <div class="w3-container w3-center w3-margin-bottom">
                    <h1> Patrick Star <span class="w3-tag w3-deep-orange">Issue ID #8482.2</span></h1>
                </div>
                <div class="w3-padding w3-third" style="text-align: center;">
                    ...
                    <ul class="w3-ul" style="text-align: left; overflow: auto; white-space: nowrap; max-height: 25rem;">
                        <li>Topic: <br><b>Software/DesktopOS/Login Issue</b></li>
                        <li>Employee: <br><b>Patrick Star A1234</b></li>
                ...
                <div class="w3-padding w3-third" style="text-align: center;">
                    ...
                    <ul class="w3-ul" style="text-align: left; overflow: auto; white-space: nowrap; max-height: 15rem;">
                        <li>14/04/18 - Main Issue:<b><br><span class="w3-tag w3-deep-orange">#8482</span></b></li>
                        <li>16/04/18 - Update 1:<b><br>Info Update <span class="w3-tag w3-deep-orange">#8482.1</span></b></li>
                        <li>22/04/18 - Update 2:<b><br>Feedback Request <span class="w3-tag w3-deep-orange">#8482.2</span></b></li>
                    </ul>
                </div>
                <div class="w3-padding w3-third" style="text-align: center;">
                    <h1> Activity </h1>
                    <div class="w3-bar w3-margin-bottom">
                        <a class="w3-margin-top w3-button w3-large w3-border w3-hover-blue w3-round-xxlarge"> Send Message </a>
                        <a id="reason" onclick="changereason()" class="w3-margin-top w3-button w3-large w3-border w3-hover-red w3-round-xxlarge"> Close Call </a>
                    </div>
                    <form>
                        <textarea style="width: 80%; height: 20rem; resize: none;" class="w3-border w3-pale-yellow w3-round-large w3-padding">Dear Mr. Patrick Star, </textarea>
                    </form>
                </div>
                <div class="w3-container w3-center w3-padding-top">
                    <a href="specialist-main.html" class="w3-margin-top w3-button w3-border w3-hover-red w3-margin-bottom w3-padding-large w3-round-xxlarge"> < Back </a>
                    <a href="new-call-done-specialist.html" class="w3-margin-top w3-button w3-large w3-border w3-hover-green w3-margin-bottom w3-padding-large w3-round-xxlarge"> Update Issue </a>
                    <br>
